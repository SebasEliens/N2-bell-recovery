...
N2BR(n,m,P)
toc
display('N2BR(n,m,P) outputs neg where neg is the negativity')
...
display('Running [neg, q] =  N2BR(n,m,P) saves both the negativity neg and the hidden variable quasi probability q')
tic
[neg, q] = N2BR(n,m,P)
toc